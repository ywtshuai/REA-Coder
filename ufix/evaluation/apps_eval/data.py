...
DATASETS_DIR = os.environ.get(
    "DATASETS_DIR",
    os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))), "Self-collaboration-Code-Generation-main", "Datasets")
)
# 若上述路径不存在，则回退到 ./Datasets（便于在 Self-collaboration 根目录运行）
if not os.path.isdir(DATASETS_DIR):
    _fallback = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))), "Datasets")
