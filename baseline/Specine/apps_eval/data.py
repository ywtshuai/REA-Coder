...
class InstanceData:
    ...
    starter_code: str
    all_test_cases: Dict[str, List[Any]]
    public_test_cases: Dict[str, List[Any]]
    solutions: List[str]
...
def load_data(data_name):
    if data_name == "apps_eval":
        data_name = "apps"
    if data_name == "code_contests_raw":
    ...
    for data in raw_data:
        if data_name == 'apps':
            ...
            instance = InstanceData(
                ...
                problem_statement=data['question'],
                starter_code=data['starter_code'],
                all_test_cases=data['all_test_cases_et'],
                public_test_cases=data['public_test_cases'],
                solutions=ast.literal_eval(data['solutions']) if data['solutions'] else []
            )
            ...
            instance = InstanceData(
                ...
                problem_statement=data['description'],
                starter_code='',
                all_test_cases=data['all_test_cases_raw'],
                public_test_cases=data['public_test_cases'],
                solutions=data['solutions']['solution']
            )
