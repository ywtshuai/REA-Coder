...
def build_messages(prompt_cfg: dict, prompt_text: str) -> list:
    return [
        {"role": "system", "content": prompt_cfg["system"]},
        {"role": "user", "content": prompt_cfg["user"].format(prompt_text=prompt_text)}
    ]
...
def classify_with_transformers(
    ...
    messages = build_messages(prompt_cfg, prompt_text)
